...
import com.demo.riverstonehomesmanagement.theme.styles.OfferingsTopTitleTextStyle
...
@Composable
fun OfferingsTopSection(modifier: Modifier = Modifier, breakpoint: Breakpoint) {
