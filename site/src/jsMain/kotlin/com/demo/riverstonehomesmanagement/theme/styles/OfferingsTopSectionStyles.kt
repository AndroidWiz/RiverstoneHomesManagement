...
val OfferingsTopSectionStyle = CssStyle {
    base {
        Modifier
            .width(100.percent)
            .height(100.vh)
...
val OfferingsTopTitleTextStyle = CssStyle {
    base {
        Modifier
            .fontSize(4.cssRem)
            .fontFamily("Rubik")
...
val OfferingsTitleTextStyle = CssStyle {
    base {
        Modifier
            .fontFamily("Rubik")
...
val OfferingsSubTitleTextStyle = CssStyle {
    base {
        Modifier
            .fontFamily("Karla")
